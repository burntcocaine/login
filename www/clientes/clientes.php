            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-dark">
                        <thead>
                            <tr>
                                <th scope="col">Alta de clientes</th>
                                <th scope="col">Baja de clientes</th>
                                <th scope="col">Actualización de clientes</th>
                        ...
                        <tbody>
                            <tr class="">
                                ...
                                <td scope="row"><a href="listado.php"><i class="bi bi-person-lines-fill px-3" style="font-size: 12rem; color:blue;"></i></a></td>
                                </tr>
