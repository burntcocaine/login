                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="ape_paterno" id="ape_paterno"  required aria-describedby="helpId" placeholder="Introduce la apellido">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number"
                            class="form-control" name="edad" id="edad" required aria-describedby="helpId" placeholder="Introduce la edad">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="dni" id="dni" required aria-describedby="helpId" placeholder="Introduce el dni">
