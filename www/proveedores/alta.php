...
<div class="container my-5">
    <div class="row">
        <div class="col text-center">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number"
                            class="form-control" name="identificador" id="identificador" autofocus required aria-describedby="helpId" placeholder="Introduce el id_proveedor">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="nif" id="nif"  required aria-describedby="helpId" placeholder="Introduce el nif">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="nombre" id="nombre"  required aria-describedby="helpId" placeholder="Introduce la nombre">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number"
                            class="form-control" name="codigo_postal" id="codigo_postal" required aria-describedby="helpId" placeholder="Introduce el codigo postal">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="id_empleado" id="id_empleado" required aria-describedby="helpId" placeholder="Introduce el id_empleado">
                          <small id="helpId" class="form-text text-muted">id_emplado</small>
                        </div>
            ...
            <a href="proveedores.php"> <i class="bi-arrow-return-left px-3" style="font-size: 4rem; color:black;"></i> </a>
        </div>  
    </div>
</div>
