            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-dark">
                        <thead>
                            <tr>
                                <th scope="col">Alta de proveedores</th>
                                <th scope="col">Baja de proveedores</th>
                                <th scope="col">Actualización de proveedores</th>
                                <th scope="col">Listado de proveedores</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="">
