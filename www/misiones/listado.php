...
<html lang="es">
<head>
    <title>Administracion BD Misiones</title>
...
<div class="container my-5">
    <div class="row">
        <div class="col text-center">
                ...
                <div class="col-md-10">
                    <div class="card">
                        ...
                        <?php
                          ...
                          $consultar= "SELECT * FROM misiones";
            ...
            <a href="http://www.foundation.asix/misiones/misiones.php"> <i class="bi-arrow-return-left px-3" style="font-size: 4rem; color:black;"></i> </a>
        </div>  
    </div>
</div>
