            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-dark">
                        <thead>
                            <tr>
                                <th scope="col">Alta de misiones</th>
                                <th scope="col">Baja de misiones</th>
                                <th scope="col">Actualización de misiones</th>
                                <th scope="col">Listado de misiones</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="">
                                <td scope="row"><a href="alta.php"><i class="bi bi-plus-circle-fill px-3" style="font-size: 12rem; color:green;"></i></a></td>
                                <td scope="row"><a href="baja.php"><i class="bi bi-dash-circle-fill px-3" style="font-size: 12rem; color:red;"></i></a></td>
                                <td scope="row"><a href="actualiza.php"><i class="bi bi-gear-fill px-3" style="font-size: 12rem; color:yellow;"></a></i></td>
                                <td scope="row"><a href="listado.php"><i class="bi bi-card-checklist px-3" style="font-size: 12rem; color:blue;"></i></a></td>
                                </tr>
