        ...
        <div class="col text-center">
            ...
            <div class="card">
                <div class="card-header display-1">
                    Administracion de localizaciones
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-dark">
                        ...
                        <tbody>
                            <tr class="">
                                <td scope="row"><a href="alta.php"><i class="bi bi-box px-3" style="font-size: 12rem; color:green;"></i></a></td>
                                <td scope="row"><a href="baja.php"><i class="bi bi-boxes px-3" style="font-size: 12rem; color:green;"></i></a></td>
                                <td scope="row"><a href="actualiza.php"><i class="bi bi-globe-americas" style="font-size: 12rem; color:green;"></a></i></td>
                                </tr>
