                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="talla" id="talla"  required value="<?php echo $registro[2];?>" aria-describedby="helpId" placeholder="Introduce la talla">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" class="form-control" name="precio" id="precio" required value="<?php echo $registro[4];?>" aria-describedby="helpId" placeholder="Introduce el precio">
