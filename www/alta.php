                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="talla" id="talla"  required aria-describedby="helpId" placeholder="Introduce la talla">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="tipo" id="tipo"  required aria-describedby="helpId" placeholder="Introduce la talla">
