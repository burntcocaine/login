...
<div class="container my-5">
    <div class="row">
        <div class="col text-center">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="nombre_donante" id="nombre_donante"  required aria-describedby="helpId" placeholder="Introduce el Nombre">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="fecha" id="fecha" required aria-describedby="helpId" placeholder="Introduce el la fecha">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="numero_donaciones" id="numero_donaciones" required aria-describedby="helpId" placeholder="Introduce el nº donaciones">
            ...
            <a href="http://www.foundation.asix/donaciones/donaciones.php"> <i class="bi-arrow-return-left px-3" style="font-size: 4rem; color:black;"></i> </a>
        </div>  
    </div>
</div>
