...
<html lang="es">
<head>
    <title>Administracion BD Miembros</title>
...
<div class="container my-5">
    <div class="row">
        <div class="col text-center">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="Nombre" id="Nombre"  required aria-describedby="helpId" placeholder="Introduce la talla">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number"
                            class="form-control" name="Apellidos" id="Apellidos" required aria-describedby="helpId" placeholder="Introduce el precio">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="Fecha_nac" id="Fecha_nac" required aria-describedby="helpId" placeholder="Introduce el precio">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="Direccion" id="Direccion" required aria-describedby="helpId" placeholder="Introduce el precio">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number"
                            class="form-control" name="Ciudad" id="Ciudad" required aria-describedby="helpId" placeholder="Introduce el precio">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number"
                            class="form-control" name="Pais" id="Pais" required aria-describedby="helpId" placeholder="Introduce el precio">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number"
                            class="form-control" name="N_cuenta" id="N_cuenta" required aria-describedby="helpId" placeholder="Introduce el precio">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number"
                            class="form-control" name="Fecha_cobr" id="Fecha_cobr" required aria-describedby="helpId" placeholder="Introduce el precio">
            ...
            <a href="http://www.foundation.asix/miembros/miembros.php"> <i class="bi-arrow-return-left px-3" style="font-size: 4rem; color:black;"></i> </a>
        </div>  
    </div>
</div>
