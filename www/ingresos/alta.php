...
<div class="container my-5">
    <div class="row">
        <div class="col text-center">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="ape_paterno" id="ape_paterno"  required aria-describedby="helpId" placeholder="Introduce la talla">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number"
                            class="form-control" name="edad" id="edad" required aria-describedby="helpId" placeholder="Introduce el precio">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="dni" id="dni" required aria-describedby="helpId" placeholder="Introduce el precio">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number"
                            class="form-control" name="telefono" id="telefono" required aria-describedby="helpId" placeholder="Introduce el precio">
            ...
            <a href="clientes.php"> <i class="bi-arrow-return-left px-3" style="font-size: 4rem; color:black;"></i> </a>
        </div>  
    </div>
</div>
