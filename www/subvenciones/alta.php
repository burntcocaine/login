                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number"
                            class="form-control" name="cantidad" id="cantidad"  required aria-describedby="helpId" placeholder="Introduce el Nombre">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="organismo" id="organismo"  required aria-describedby="helpId" placeholder="Introduce la talla">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="fecha_sub" id="fecha_sub" required aria-describedby="helpId" placeholder="Introduce el precio">
                          <small id="helpId" class="form-text text-muted">fecha subvencion</small>
                        </div>
