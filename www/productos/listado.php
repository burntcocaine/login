...
<header class="navbar navbar-inverse" role="banner">
        ...
        <a href="carrito.php"><button type="button" class="btn btn-primary" data-toggle="button" aria-pressed="false" autocomplete="off">
  <p style="font-size: 2rem; color:white;">Cesta</p> <i class="bi bi-cart px-1" style="font-size: 2rem; color:white;"></i><a>
</button>
        ...
        <div class="col text-center">
            ...
            <div class="card">
                <div class="card-header display-8">
                    Descargar en pdf <a href="http://foundation.asix/productos/productos_pdf.php" title="Descargar Listado" target="_blank">
                          ...
                          <table class="table table-hover">
                            ...
                            <tbody>
                              ...
                              <tr class="align-middle">
                                ...
                                <td><a href="carrito2.php?id=<?php echo $registro[0]; ?>&nombre=<?php echo urlencode($registro[1]); ?>&descripcion=<?php echo urlencode($registro[2]); ?>&precio=<?php echo $registro[3]; ?>&fotografia=<?php echo urlencode($registro[4]); ?>">
                                <button type="button"><i class="bi bi-cart px-1" style="font-size: 2rem; color:green;"></i></button>
                                  </a>
                                </td>
                              </tr>
            ...
            <a href="http://foundation.asix/productos/productos.php"> <i class="bi-arrow-return-left px-3" style="font-size: 4rem; color:black;"></i> </a>
        </div>  
    </div>
</div>
