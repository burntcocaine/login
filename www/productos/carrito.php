        ...
        <div class="col text-center">
            ...
            <div class="card">
                <div class="card-header display-6">
                    Carrito de <?php echo ": ".$_SESSION['usuario'] ?>
                </div>                
            </div>
            ...
            <div class="row mt-3 justify-content-md-center">
                <div class="col-md-10">
                    <div class="card">
                          ...
                          <table class="table table-hover">
                            <thead>
                              <tr>
                                ...
                                <th scope="col">Quitar de la cesta</th>
                            ...
                            <tbody>
                              ...
                              <tr class="align-middle">
                                ...
                                <td><a href="carrito_baja.php?id=<?php echo $registro[0]; ?>"><i class="bi bi-cart-x px-1" style="font-size: 2rem; color:red;"></td>
                          ...
                          <table class="table table-hover">
                            ...
                            <tbody>
                              ...
                              <tr class="align-middle">
                                ...
                                <td scope="row"><h1>TOTAL:<h1 style="color:green;"><?php echo $registro[0]; ?>€</h1></td>
                        ...
                        <a href="../paypal/index.php" target="_blank"><input type="image" src="../imagenes/paypal.png" width="250" name="submit" alt="PayPal, la forma más segura y rápida de pagar en línea."> </a>
                        <?php
                                }
                              ?>
                    </div>
            ...
            <a href="./listado.php"> <i class="bi-arrow-return-left px-3" style="font-size: 4rem; color:black;"></i> </a>
        </div>  
    </div>
</div>
