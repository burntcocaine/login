            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-dark">
                        <thead>
                            <tr>
                                <th scope="col">Alta de productos</th>
                                <th scope="col">Baja de productos</th>
                        ...
                        <tbody>
                            <tr class="">
                                <td scope="row"><a href="alta.php"><i class="bi bi-bag-check px-3" style="font-size: 12rem; color:green;"></i></a></td>
                                <td scope="row"><a href="baja.php"><i class="bi bi-bag-dash px-3" style="font-size: 12rem; color:red;"></i></a></td>
                                <td scope="row"><a href="actualiza.php"><i class="bi bi-gear-wide px-3" style="font-size: 12rem; color:yellow;"></a></i></td>
                                <td scope="row"><a href="listado.php"><i class="bi bi-card-list px-3" style="font-size: 12rem; color:blue;"></i></a></td>
                                </tr>
