                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="pais" id="pais"  required aria-describedby="helpId" placeholder="Introduce el pais">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="ciudad" id="ciudad"  required aria-describedby="helpId" placeholder="Introduce la ciudad">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text"
                            class="form-control" name="provincia" id="provincia"  required aria-describedby="helpId" placeholder="Introduce la provincia">
