      ...
      <div class='modal-body'>
        ...
        <form class='form-horizontal well' data-async data-target='#rating-modal'>
            ...
            <div class='form-group'>
                ...
                <div class='form-group'>
                    <label for='ape_pedit' class='col-lg-2 control-label'>Contraseña</label>
                    <div class='col-lg-10'>
                        <input type='text' class='form-control' name='ape_pedit' id='ape_pedit' value=".mb_convert_encoding($edit_clientes[2],'UTF-8').">
                    </div>
                </div>
                <div class='form-group'>
                    <label for='edad_edit' class='col-lg-2 control-label'>Estado</label>
                    <div class='col-lg-10'>
                        <input type='text' class='form-control' name='edad_edit' id='edad_edit' value=".$edit_clientes[3].">
                    </div>
                </div>
                <div class='form-group'>
                    <label for='dir_edit' class='col-lg-2 control-label'>NombreCompleto</label>
                    <div class='col-lg-10'>
                        <input type='text' class='form-control' name='dir_edit' id='dir_edit' value='$edit_clientes[4]'>
                    </div>
                </div>
                <div class='form-group'>
